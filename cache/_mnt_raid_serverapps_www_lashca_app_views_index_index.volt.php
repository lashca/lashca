...
<html lang="ja">
    <head>
        ...
        <meta name="keywords" content="ラシュカ,lashca,単語帳,暗記">
        <title><?= $title ?></title>
...
<body>
    <!-- Navigation
    ================================================== -->
    <nav class="navbar navbar-dark bg-gray bg-inverse-custom navbar-fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">
          <img  src="/img/logo_wh.png" width="100" alt="Lashca" title="Lashca"/>
          <span class="sr-only">Lashca.com</span>
        </a>
        ...
        <div id="collapsingNavbar" class="collapse navbar-toggleable-custom" role="tabpanel" aria-labelledby="collapsingNavbar">
          <ul class="nav navbar-nav pull-xs-right">
            <li class="nav-item nav-item-toggable ">
              <a class="nav-link" href="./index-carousel.html">機能<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item nav-item-toggable">
              <a class="nav-link" href="ui-elements.html">料金</a>
            </li>
            <li class="nav-item nav-item-toggable">
              <a class="nav-link" href="ui-elements.html">使い方</a>
            </li>
  ...
  <div class="container">
    <h1 class="display-3">Lashca</h1>
    <h2 class="m-b-3">クラウド単語帳 meets 学習心理学</h2>
    <a class="btn btn-outline-secondary m-b-1 start-btn" href="/signup" role="button">無料で始める</a>
  ...
  <section class="section-intro bg-faded text-xs-center">
    <div class="container">
      <h3 class="wp wp-1">勉強をより楽しくする学生・社会人のためのサービス</h3>
      <p class="lead wp wp-2">入試・資格試験の暗記学習の効率化と暗記状況の可視化</p>
        ...
        <div class="col-md-4">
          <div class="card">
            <div class="card-block">
              <span class="icon-stats-dots display-1"></span>
              <h4 class="card-title">可視化</h4>
              <hr />
              <p class="card-text text-muted">問題毎の正答履歴や時間経過から<br />現在の暗記状況を推定</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card">
            <div class="card-block">
              <span class="icon-calendar display-1"></span>
              <h4 class="card-title">学習計画</h4>
              <hr />
              <p class="card-text text-muted">個人の暗記状況に合わせた<br />最適な学習順序を導出</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card m-b-0">
            <div class="card-block">
              <span class="icon-book display-1"></span>
              <h4 class="card-title">問題管理</h4>
              <hr />
              <p class="card-text text-muted">問題情報の入力・一覧表示と<br />各種試験の過去問購入</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="section-text">
    <div class="container">
      ...
      <div class="row p-y-3">
        ...
        <div class="col-md-5 offset-md-2 separator-x">
        ...
        <div class="row">
          ...
          <div class="col-md-6 p-l-0">
            <article class="m-x-auto">
              <span class="tag tag-info">Featured article</span>
              <br>
              <h5><a href="#">Design studio with product designer Peter Finlan <span class="icon-arrow-right"></span></a></h5>
              <p class="m-b-0">
                <a href="#"><span class="tag tag-default text-uppercase"><span class="icon-tag"></span> Design Studio</span></a>
                <a href="#"><span class="tag tag-default text-uppercase"><span class="icon-time"></span> 1 Hour Ago</span></a>
              </p>
            </article>
          </div>
        </div>
  ...
  <?= $this->partial('layouts/partial/footer') ?>
